...
from ..core.exceptions import PersistenceError, DataLoaderError
from ..core.interfaces import BaseEncoder, BaseHasher, BaseSimilarity
...
class LSHSystemLoader:
    ...
    def _recreate_system(
        ...
        from ..core.main import LSHRecommender, RecommendationPipeline
